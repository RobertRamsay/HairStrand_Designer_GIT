...
draw_text(0,0,string("Real FPS: "+string(fps_real)));
draw_text(0,12,string("Blur amount(Q & A to adjust): "+string(var_blur_amount)));

draw_text(0,60,string("Spacebar to toggle shader"));
draw_text(0,72,string("Escape key to exit"));
